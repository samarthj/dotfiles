...
function M.format_formatprg()
    local ok, formatprg = pcall(function()
...
function M.format_code()
    if vim.tbl_contains(vim.g.force_neoformat_filetypes, vim.bo.filetype) or vim.tbl_isempty(vim.lsp.buf_get_clients(0)) then
        vim.cmd('Neoformat')
    else
